export const lightTheme = {
  ...
  popupBg: "linear-gradient(145deg, #d9c9c5, #a28b83)",
  modalShadows: "13px 13px 40px #232120cf, -13px -13px 40px #232222c4",
  iconBtnHover: "#b8ada8",
  color: "red",
...
export const darkTheme = {
  ...
  popupBg: "linear-gradient(145deg, #2d2c2d, #1f1d1f)",
  modalShadows: "13px 13px 40px #070707cf, -13px -13px 40px #181716d1",
  color: "purple",
